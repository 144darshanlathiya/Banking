...
import com.example.banking.modal.dto.ReceiverDetails;
import com.example.banking.modal.dto.SenderDetails;
...
public class TransferMoney {
    ...
    private TransferMoney(SenderDetails senderDetails, ReceiverDetails receiverDetails, double transferMoney) {
    ...
    public static class Builder {
        ...
        public TransferMoney build() {
            return new TransferMoney(senderDetails, receiverDetails, transferMoney);
        }
    }
